...
class TestPyutPreferencesV2(UnitTestBase):
    ...
    def testBooleanValuesPresent(self):
        ...
        autoResizedOnEdit:       bool = self._preferences.autoResizeShapeOnEdit
        ...
        self._preferences.autoResizeShapeOnEdit   = False
        ...
        try:
            ...
            self.assertFalse(self._preferences.autoResizeShapeOnEdit, '')
            ...
            self._preferences.autoResizeShapeOnEdit   = autoResizedOnEdit
