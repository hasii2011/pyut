...
class SharedIdentifiers:
    ...
    [
        ...
        ID_MNU_HELP_INDEX,
        ID_MNU_HELP_WEB, ID_MNU_FILE_EXPORT, ID_MNU_FILE_EXPORT_BMP,
        ID_MNU_EDIT_SHOW_TOOLBAR, ID_ARROW, ID_CLASS,
        ID_REL_INHERITANCE, ID_REL_REALISATION,
        ID_REL_COMPOSITION,
        ID_REL_AGGREGATION, ID_REL_ASSOCIATION, ID_MNU_FILE_EXPORT_JPG,
        ID_MNU_PROJECT_CLOSE, ID_NOTE, ID_ACTOR,
        ID_USECASE, ID_REL_NOTE, ID_MNU_HELP_VERSION,
        ID_MNU_FILE_EXPORT_PS, ID_MNU_FILE_EXPORT_PNG, ID_MENU_FILE_PYUT_PREFERENCES,
        ID_MNU_FILE_EXPORT_PDF, ID_MNU_FILE_NEW_CLASS_DIAGRAM, ID_MNU_FILE_NEW_SEQUENCE_DIAGRAM,
