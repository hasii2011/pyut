...
[
    ...
    ID_MNUFILENEWCLASSDIAGRAM, ID_MNUFILENEWSEQUENCEDIAGRAM, ID_MNUFILENEWUSECASEDIAGRAM,
    ID_MNUFILEOPEN, ID_MNUFILESAVE,
    ID_ARROW, ID_ZOOMIN, ID_ZOOMOUT, ID_MNUUNDO, ID_MNUREDO,

    ID_CLASS,
    ID_REL_INHERITANCE, ID_REL_REALISATION, ID_REL_COMPOSITION,
    ID_REL_AGGREGATION,  ID_REL_ASSOCIATION, ID_REL_NOTE,
    ID_NOTE, ID_ACTOR, ID_USECASE,


    ID_SD_INSTANCE, ID_SD_MESSAGE
] = PyutUtils.assignID(23)
...
class ToolsCreator:
    ...
    def initTools(self):
        ...
        toolArrow = Tool("pyut-arrow", ImgToolboxArrow.embeddedImage.GetBitmap(),
                         ...
                         (lambda x: self._callbackMap[ActionCallbackType.NEW_ACTION]),
        ...
        toolNewProject = Tool("pyut-new-project", ImgToolboxNewProject.embeddedImage.GetBitmap(),
                              ...
                              (lambda x: self._callbackMap[ActionCallbackType.NEW_PROJECT]),
        ...
        toolNewClassDiagram = Tool("pyut-new-class-diagram", ImgToolboxNewClassDiagram.embeddedImage.GetBitmap(),
                                   ...
                                   (lambda x: self._callbackMap[ActionCallbackType.NEW_CLASS_DIAGRAM]),
        ...
        toolNewSequenceDiagram = Tool("pyut-new-sequence-diagram", ImgToolboxNewSequenceDiagram.embeddedImage.GetBitmap(),
                                      ...
                                      (lambda x: self._callbackMap[ActionCallbackType.NEW_SEQUENCE_DIAGRAM]),
        ...
        toolNewUseCaseDiagram = Tool("pyut-new-use-case-diagram", ImgToolboxNewUseCaseDiagram.embeddedImage.GetBitmap(),
                                     ...
                                     (lambda x: self._callbackMap[ActionCallbackType.NEW_USE_CASE_DIAGRAM]),
        ...
        toolOpen = Tool("pyut-open", ImgToolboxOpenFile.embeddedImage.GetBitmap(),
                        ...
                        (lambda x: self._callbackMap[ActionCallbackType.FILE_OPEN]),
        ...
        toolUndo = Tool("pyut-undo", ImgToolboxUndo.embeddedImage.GetBitmap(),
                        ...
                        (lambda x: self._callbackMap[ActionCallbackType.UNDO]),
        ...
        toolRedo = Tool("pyut-redo", ImgToolboxRedo.embeddedImage.GetBitmap(),
                        ...
                        (lambda x: self._callbackMap[ActionCallbackType.REDO]),
        ...
        toolRelAgregation = Tool("pyut-rel-aggregation", ImgToolboxRelationshipAggregation.embeddedImage.GetBitmap(),
                                 ...
                                 # (lambda x: self._OnNewAction(x)),
                                 (lambda x: self._callbackMap[ActionCallbackType.NEW_ACTION]),
                                 cast(Callable, None), wxID=ID_REL_AGGREGATION, isToggle=True)
        ...
        self._ctrl.registerToolBarTools([
            ...
            ID_REL_REALISATION, ID_REL_COMPOSITION, ID_REL_AGGREGATION,
